...
const CustomButton = ({ title, textStyles, containerStyles, imageStyles, imageStyles2, func }) => {
  return (
    <div onClick={() => {func()}} className={`relative flex items-center justify-center px-6 py-2 rounded-[20px] cursor-pointer ${containerStyles}`}>
      ...
      <Image src="/assets/btn-blur.png" className={`absolute z-0 w-full h-full object-contain -bottom-1/5 rounded-full ${imageStyles2}`} width={200} height={200} alt="" />
